...
namespace spaceinvaders {
    ...
    constexpr float PLAYER_START_Y = LOGICAL_HEIGHT - PLAYER_HEIGHT - 4.0f;
    ...
    constexpr float BUNKER_Y = LOGICAL_HEIGHT - PLAYER_HEIGHT - 40.0f;
    ...
    constexpr float ALIEN_SPACING_Y = 14.0f;
